...
class GitVcsInfoExtension : VcsInfoExtension {
    override fun getCurrentVcsBranch(project: Project, file: VirtualFile?): String? = ReadAction.compute<String?, Nothing> {
        val manager = GitRepositoryManager.getInstance(project)
        return@compute DvcsUtil.guessRepositoryForFile(project, manager, file, null)?.currentBranchName
    }
}

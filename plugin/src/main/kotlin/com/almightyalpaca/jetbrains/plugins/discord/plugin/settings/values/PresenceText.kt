...
enum class PresenceText(override val text: String, override val description: String? = null) : RenderedValue<PresenceText.Result>, UiValueType {
    ...
    companion object {
        ...
        val Idle1 = CUSTOM to arrayOf(NONE, APPLICATION_VERSION, APPLICATION_NAME,  CUSTOM)
        val Idle2 = NONE to arrayOf(NONE, APPLICATION_VERSION, APPLICATION_NAME,  CUSTOM)

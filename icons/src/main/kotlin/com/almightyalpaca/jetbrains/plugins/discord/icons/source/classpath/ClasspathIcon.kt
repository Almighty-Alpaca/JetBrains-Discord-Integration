...
class ClasspathIcon(name: String, asset: Asset) : AbstractIcon(name, asset) {
    constructor(source: ClasspathSource, name: String, assetId: String, theme: Theme, applicationName: String) : this(name, ClasspathAsset(source, assetId, theme, applicationName))
}

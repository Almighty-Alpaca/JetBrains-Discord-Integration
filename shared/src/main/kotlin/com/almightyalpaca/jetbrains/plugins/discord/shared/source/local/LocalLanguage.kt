...
object LocalLanguage {
    class Simple(source: LocalSource, id: String, name: String, parent: Language?, assetId: String?, matchers: Map<Matcher.Target, Matcher>, flavors: Set<Language>) : AbstractLanguage.Simple(id, name, parent, assetId, matchers, flavors) {
